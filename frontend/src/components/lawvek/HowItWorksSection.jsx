...
export const HowItWorksSection = () => {
  ...
  const stages = [
    { id: 0, label: 'Request', icon: FileText, color: '#10B981' },
    { id: 1, label: 'AI Analysis', icon: Bot, color: '#10B981' },
    { id: 2, label: 'Paralegal', icon: User, color: '#10B981' },
    { id: 3, label: 'Senior Attorney', icon: UserCheck, color: '#10B981' },
    { id: 4, label: 'Delivered', icon: CheckCircle, color: '#10B981' },
  ];

...
export const HeroSection = ({ onOpenModal, queueCount = 37 }) => {
  ...
  return (
    ...
    >
      ...
      {/* Content - Centered with Parallax */}
      <motion.div 
      ...
      >
        ...
        >
          <motion.span 
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-amber-500/10 border border-amber-500/30 rounded-full"

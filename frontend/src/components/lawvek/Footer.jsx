...
export const Footer = () => {
  ...
  return (
    <footer 
      className="bg-white border-t border-[#E2E8F0] py-12"
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          >
            <a href="/" className="text-xl font-serif font-semibold text-[#1E293B] tracking-tight">
              Lawvek
            </a>
          </motion.div>
          ...
          {/* Year */}
          <motion.span
            className="text-xs font-mono text-[#475569]/60"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
        ...
        >
          <p className="text-xs font-sans text-[#475569]/70 max-w-2xl mx-auto leading-relaxed">
